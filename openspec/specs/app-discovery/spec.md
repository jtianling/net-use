...
Discover installed and running macOS applications by scanning app bundles and enumerating running processes, providing metadata for app identification and selection.
